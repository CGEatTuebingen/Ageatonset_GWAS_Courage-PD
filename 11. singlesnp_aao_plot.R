...
#BST1 SNP data extraction (using plink on linux terminal); where mergedageatonset_pooled is the genotype data from PD GWAS on 8535 PD patients with AAO data
